...
export const AppStoreContext = ((globalThis as any).__APP_STORE_CONTEXT__ ||= React.createContext<AppStateStore | null>(null));
type Props = {
  children: React.ReactNode;
...
const HasAppStateContext = ((globalThis as any).__HAS_APP_STATE_CONTEXT__ ||= React.createContext<boolean>(false));
