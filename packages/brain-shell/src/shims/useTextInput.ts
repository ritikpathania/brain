import { isInputModeCharacter } from '../../vendor/claude/components/PromptInput/inputModes.js'
import { useNotifications } from '../../vendor/claude/context/notifications.js'
import stripAnsi from 'strip-ansi'
import { markBackslashReturnUsed } from '../../vendor/claude/commands/terminalSetup/terminalSetup.js'
import { addToHistory } from '../../vendor/claude/history.js'
import type { Key } from '../../vendor/claude/ink.js'
import type {
  InlineGhostText,
  TextInputState,
} from '../../vendor/claude/types/textInputTypes.js'
import {
  Cursor,
  getLastKill,
  pushToKillRing,
  ...
  updateYankLength,
  yankPop,
} from '../../vendor/claude/utils/Cursor.js'
import { env } from '../../vendor/claude/utils/env.js'
import { isFullscreenEnvEnabled } from '../../vendor/claude/utils/fullscreen.js'
import type { ImageDimensions } from '../../vendor/claude/utils/imageResizer.js'
import { isModifierPressed, prewarmModifiers } from '../../vendor/claude/utils/modifiers.js'
import { useDoublePress } from '../../vendor/claude/hooks/useDoublePress.js'
