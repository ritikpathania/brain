...
import type { VimInputState, VimMode } from '../../vendor/claude/types/textInputTypes.js'
import { Cursor } from '../../vendor/claude/utils/Cursor.js'
import { lastGrapheme } from '../../vendor/claude/utils/intl.js'
import {
  executeIndent,
  executeJoin,
  executeOpenLine,
...
} from '../../vendor/claude/vim/operators.js'
import { type TransitionContext, transition } from '../../vendor/claude/vim/transitions.js'
import {
  ...
  type RecordedChange,
  type VimState,
} from '../../vendor/claude/vim/types.js'
import { type UseTextInputProps, useTextInput } from '../../vendor/claude/hooks/useTextInput.js'
...
export function useVimInput(props: UseVimInputProps): VimInputState {
  ...
  function handleVimInput(rawInput: string, key: Key): void {
    ...
    if (key.escape && state.mode === 'INSERT') {
      if (props.disableEscapeDoublePress) {
        return
      }
      switchToNormalMode()
      return
