...
*   **[storage.md](file:///Users/ritikpathania/Developer/PyCharm/brain/docs/reference/storage.md)**: Documents the transactional (SQLite) and analytical (DuckDB) database schemas. Explains raw BLOB storage for vector embeddings, relational graph indices, and background analytics synchronization.
