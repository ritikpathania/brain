...
## Consequences
* **Robustness**: Tests do not break when weights are calibrated or updated; they only break if fundamental mathematical rules are violated.
* **Clarity**: The tests document the architectural and mathematical constraints of the system.
* **Complexity**: Designing invariant assertions requires more effort than writing simple mock assertions.
