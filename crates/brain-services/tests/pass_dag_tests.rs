...
fn test_topological_sort_independent_and_branching() {
    ...
    let p_canon = DummyPass {
        id: PassId::new("canonicalization"),
        deps: vec![],
    };
    let p_contra = DummyPass {
        id: PassId::new("contradiction"),
        deps: vec![PassId::new("canonicalization")],
    };
    let p_dup = DummyPass {
        id: PassId::new("duplicate"),
        deps: vec![PassId::new("canonicalization")],
    };
    let p_conf = DummyPass {
        id: PassId::new("confidence"),
        deps: vec![PassId::new("contradiction"), PassId::new("duplicate")],
    };
...
fn test_missing_dependency_rejection() {
    ...
    let p1 = DummyPass {
        id: PassId::new("p1"),
        deps: vec![PassId::new("missing_dep")],
    };
...
fn test_cyclic_dependency_rejection() {
    ...
    let p1 = DummyPass {
        id: PassId::new("p1"),
        deps: vec![PassId::new("p2")],
    };
    let p2 = DummyPass {
        id: PassId::new("p2"),
        deps: vec![PassId::new("p1")],
    };
