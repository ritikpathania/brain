...
| | LambdaMART | 0.9230 | 0.1071 | 0.7806 | 1.0000 |
...
| | LambdaMART | 0.9187 | 0.1153 | 0.7540 | 1.0000 |
...
> [NOTE]
> Under 5-Fold Cross-Validation, LambdaMART achieved a mean Composite score of **0.9230**, while the Linear Baseline maintained **0.9372** (Delta: **-0.0142**). This demonstrates that while LambdaMART learns complex local non-linear interactions, the linear model calibrated over multiple folds remains a very strong competitor for this corpus scale.
