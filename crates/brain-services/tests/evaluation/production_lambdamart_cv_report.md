...
| | LambdaMART | 0.9397 | 0.0959 | 0.7803 | 1.0000 |
| **nDCG@5** | Linear Baseline | 0.9268 | 0.0676 | 0.8155 | 1.0000 |
| | Logistic Regression | 0.8899 | 0.0272 | 0.8770 | 0.9385 |
| | LambdaMART | 0.9354 | 0.1002 | 0.7718 | 1.0000 |
| **MRR** | Linear Baseline | 0.9167 | 0.1021 | 0.7500 | 1.0000 |
| | Logistic Regression | 0.8667 | 0.0456 | 0.8333 | 0.9167 |
| | LambdaMART | 0.9255 | 0.1108 | 0.7526 | 1.0000 |
| **Recall@5** | Linear Baseline | 0.9889 | 0.0248 | 0.9444 | 1.0000 |
| | Logistic Regression | 0.9889 | 0.0248 | 0.9444 | 1.0000 |
| | LambdaMART | 0.9667 | 0.0745 | 0.8333 | 1.0000 |

## Research Conclusion

> [NOTE]
> Under 5-Fold Cross-Validation, LambdaMART achieved a mean Composite score of **0.9397**, outperforming the Linear Baseline's mean of **0.9372** by **+0.0025**. The min/max distributions confirm that listwise boosting generalize consistently across diverse query folds.
