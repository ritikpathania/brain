...
| | LambdaMART | 0.9229 | 0.1073 | 0.7804 | 1.0000 |
...
| | LambdaMART | 0.9182 | 0.1160 | 0.7531 | 1.0000 |
...
> [NOTE]
> Under 5-Fold Cross-Validation, LambdaMART achieved a mean Composite score of **0.9229**, while the Linear Baseline maintained **0.9372** (Delta: **-0.0143**). This demonstrates that while LambdaMART learns complex local non-linear interactions, the linear model calibrated over multiple folds remains a very strong competitor for this corpus scale.
