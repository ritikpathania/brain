...
| | LambdaMART | 0.9232 | 0.1066 | 0.7825 | 1.0000 |
...
| | LambdaMART | 0.9198 | 0.1127 | 0.7639 | 1.0000 |
...
> [NOTE]
> Under 5-Fold Cross-Validation, LambdaMART achieved a mean Composite score of **0.9232**, while the Linear Baseline maintained **0.9372** (Delta: **-0.0140**). This demonstrates that while LambdaMART learns complex local non-linear interactions, the linear model calibrated over multiple folds remains a very strong competitor for this corpus scale.
