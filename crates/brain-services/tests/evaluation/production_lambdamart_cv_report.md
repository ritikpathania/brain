...
> [NOTE]
> Under 5-Fold Cross-Validation, LambdaMART achieved a mean Composite score of **0.9121**, while the Linear Baseline maintained **0.9229** (Delta: **-0.0107**). This demonstrates that while LambdaMART learns complex local non-linear interactions, the linear model calibrated over multiple folds remains a very strong competitor for this corpus scale.
