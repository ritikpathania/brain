...
> [NOTE]
> Under 5-Fold Cross-Validation, LambdaMART achieved a mean Composite score of **0.9385**, outperforming the Linear Baseline's mean of **0.9372** by **+0.0012**. The min/max distributions confirm that listwise boosting generalize consistently across diverse query folds.
