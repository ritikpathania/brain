...
| **LambdaMART (Selected)** | 0.9560 | 0.9544 | 0.9504 | 0.9667 |
...
| **LambdaMART** | 0.9866 | 0.8337 | 0.9846 | 0.8333 | 0.9792 | 0.8351 |
...
| **Average Scoring Latency** | 31.99 ns |

## Gain-Based Feature Importance

| Rank | Feature | Normalized Gain Importance |
| :--- | :--- | ---: |
| 1 | `SemanticSimilarity` | 0.5415 |
| 2 | `ProvenanceConfidence` | 0.4584 |
| 3 | `LexicalSimilarity` | 0.0001 |
