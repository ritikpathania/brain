...
use crate::temporal::{RecencyPolicy, TimePoint, TemporalQuery, TemporalEdge};
...
impl RecencyEvaluation {
    ...
    pub fn new(
        ...
        let elapsed = reference_time.unix_seconds().saturating_sub(observed_at.unix_seconds()) as f64;
...
impl HistoricalExplanationBuilder {
    ...
    pub fn build_visibility_evidence(
        edge: &TemporalEdge,
        query: &TemporalQuery,
    ) -> Evidence {
    ...
    pub fn build_decay_evidence(
        eval: &RecencyEvaluation,
    ) -> Evidence {
